import{b as n,r as i,j as e}from"./app-BEStXNts.js";/* empty css            */function c({bg:t}){const{isPlaying:s,toggleMusic:a}=n(),r=i.useRef(null);return i.useEffect(()=>{r.current&&(s?r.current.style.animation="spin 2s linear infinite":r.current.style.animation="none")},[s]),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        @keyframes spin {
          from {
