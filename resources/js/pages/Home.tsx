...
export default function Home({ title, description }: Props) {
    ...
    return (
      ...
      `}</style>
            ...
            <div ref={titleRef} className="absolute top-1/2 left-1/2 z-10 w-[60%] -translate-x-1/2 -translate-y-1/2 text-center">
          ...
          >
            <p className="text-xs md:text-sm tracking-wider uppercase opacity-90">
              {slides[currentIndex].material}
                    ...
                    <p
                        ref={descRef}
                        className="mb-5 max-w-xl leading-relaxed opacity-90"
                    >
            ...
            <button
                ref={gifRef}
                onClick={toggleMusic}
                className="fixed right-4 bottom-4 z-[50] flex aspect-square w-13 cursor-pointer items-center justify-center rounded-full border border-white/30 bg-white/20 p-1 transition-transform duration-200 hover:scale-110"
